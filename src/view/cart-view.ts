...
class CartView {
  ...
  private static fillSummary(parentBlock: HTMLElement): void {
    Builder.fillTextBlock(parentBlock, '.summary__products span', Cart.getTotalAmount().toString());
    Builder.fillTextBlock(parentBlock, '.summary__total span', Cart.getCartSum().toString(), true);
  }
